...
> **v2.24.5**: pembaruan tampilan menyeluruh — **transisi antar layar** (buka
> album/artis/folder, ganti tab, pemutar video naik dari bawah), **mini player
> beranimasi**, **beranda muncul halus** dengan kartu **"Lanjutkan
> mendengarkan"**, **sampul kosong bergradien + huruf awal**, miniatur video
> **berkilau saat memuat** dan **disimpan** (tidak lagi abu-abu setiap dibuka),
> tab Video jadi **kisi 2 kolom**, **getaran halus** saat tekan lama/geser/kunci
> video, dan panel kontrol pemutar video memakai gradien.
>
...
> berlaku selama menonton, dan kembali ke setelan sistem begitu keluar.
>
> **v2.24.1**: pemutar video dapat dua kontrol baru — **kecepatan putar**
> (0,5× / 0,75× / 1× / 1,25× / 1,5× / 2×) dan **mode tampilan
> Fit / Isi / Zoom**, sehingga video 4:3 atau layar lebar bisa dibuat memenuhi
> layar. Penghitung antrian (mis. "3/12") pindah ke baris judul supaya judul
> video tetap lega.
>
...
> (Paparazzi) yang dipasang di v2.20.0 dicabut: build jadi lebih lama dan
> penilaian tampilan dilakukan langsung di HP.
>
...
- **Video**: tab Video memindai video di HP — ketuk untuk memutar
  fullscreen di dalam app (play/pause/seek), tetap offline. Di layar pemutar
...
https://github.com/zenn889/PureWave/releases — ambil `purewave-v2.24.5.apk`.
